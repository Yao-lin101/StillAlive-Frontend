  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto mb-4 pr-2 -mr-2">
        <Card className="p-6 bg-white/50 dark:bg-slate-800/50">
          <div className="prose prose-slate dark:prose-invert max-w-none 
            ...
            prose-code:bg-gray-100 dark:prose-code:bg-slate-700 prose-code:px-2 prose-code:py-1 prose-code:rounded prose-code:text-sm">
            <ReactMarkdown>
              {analysis.markdown || analysis.error || '暂无分析内容'}
            </ReactMarkdown>
          </div>
        </Card>
      </div>
        ...
        <div>
          {onBack && (
            <Button
              ...
              size="sm"
              onClick={onBack}
              className="text-xs h-9 bg-white/50 dark:bg-slate-800/50"
            >
        ...
        {isOwner && (
          <div className="flex gap-2">
            ...
            <Button
              ...
              className="text-xs h-9 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 border-red-200 dark:border-red-800 hover:bg-red-100 dark:hover:bg-red-900/30"
            >
